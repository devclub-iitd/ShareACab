  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:
          requests.isEmpty?
              Center(
                child: Text('No Requests to show', style: TextStyle(fontSize: 25.0),),
              ) :
      ListView.builder(
                        ...
                        Flexible(
                          ...
                          child: Container(
                            ...
                            Column(children: <Widget>[
                              FlatButton(
                                onPressed: null,
                                child: Text('Accepted', style: TextStyle(color: requestAccepted(context))),
                              ),
                              FlatButton(
                                onPressed: null,
                                child: Text('Join Now', style: TextStyle(color: requestAccepted(context))),
                              )
                            ],)
                            ...
                            Column(children: <Widget>[
                              FlatButton(
                                onPressed: null,
                                child: Text('Rejected', style: TextStyle(color: requestRejected(context))),
                              ),
                              FlatButton(
                                onPressed: null,
                                child: Text('View Message',style: TextStyle(color: getVisibleColorOnPrimaryColor(context), fontSize: 11.8)),
                              )
                            ],): Column(children: <Widget>[
                              FlatButton(
                                onPressed: null,
                                child: Text('Pending', style: TextStyle(color: requestPending(context))),
                              ),
                              FlatButton(
                                onPressed: null,
                                child: Text('View Message',style: TextStyle(fontSize: 11.8),),
                              )
                            ],)
                          )
                        )
