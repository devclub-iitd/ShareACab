...
class TripsList extends StatefulWidget {
  ...
  final refreshParent;
  TripsList(this._dest, this._selectedDestination, this._notPrivate, this.refreshParent);
  @override
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder(
        ...
        builder: (_, usersnapshot) {
          _scrollController
            ..addListener(() {
              if (_scrollController.position.userScrollDirection.toString() != globals.scrollDirection) {
                setState(() {
                  globals.scrollDirection = _scrollController.position.userScrollDirection.toString();
                });
