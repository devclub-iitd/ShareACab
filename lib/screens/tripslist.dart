...
import 'package:shareacab/shared/globals.dart' as globals;
...
class _TripsListState extends State<TripsList> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: StreamBuilder(
          ...
          builder: (_, usersnapshot) {
            ...
            _controller.addListener(() {
              if (_controller.position.userScrollDirection.toString() != globals.scrollDirection) {
                setState(() {
                  globals.scrollDirection = _controller.position.userScrollDirection.toString();
                });
              }
            });
            return Container(
      ...
      floatingActionButton: globals.scrollDirection=='ScrollDirection.reverse'?Container():(widget.inGroupFetch
          ? !widget.inGroup
              ? Padding(
